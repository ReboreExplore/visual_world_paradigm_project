...
```python
referent_calc_sets = pd.concat([one_hot_count_df_full_competitor_sets, one_hot_count_df_cohort_competitor_sets, 
...
groupby_time_bins_df_referent = referent_calc_sets.groupby(['bin_start', 'bin_end']).sum().reset_index()
