...
![Probability of fixating on each item type over time in the full competitor condition](img/ref_graph.png){#fig-ref-graph width=90%}
...
- **Eye Tracker**: The experiment is conducted using the GazePoint GP3+ eye tracker. It is a binocular eye tracker that can record at 150 Hz.  The eye tracker is connected to the computer and the participants are seated at a distance of around 60 cm from the screen. The experiment was conducted in a dimly lit laboratory setup to avoid any external light source that might interfere with the eye tracking.
...
![User Interface of one trial](img/stim_grid.png){#fig-ui width=70%}
...
The timeline of one trial is shown in @fig-ui.
