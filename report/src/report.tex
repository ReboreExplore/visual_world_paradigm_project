...
\item
  ...
  \item
    ...
    \item
      ...
      \tightlist
      \item
        \textbf{Instruction} : 'FixateHow to run the analysisbject that
        the participants have to click on. You can find the audio
        stimuli \href{stimuli/audio-stimuli}{here}. Each response is
        captured with a mouse click. The mouse click is recorded and
        logged using the mouse\_response item in OpenSesame.
      \end{itemize}
    \end{enumerate}
  \item
